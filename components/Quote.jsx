...
export const Quote = () => {
  return (
    <div className="w-[100%] h-[360px] bg-primary-500 flex items-center justify-center">
      ...
      <div className="w-[1200px] h-[250px] flex items-center justify-center mx-auto relative">
        <div className="flex items-center justify-center absolute  w-[100%] lg:max-w-[1140px] m-">
        ...
        <div className="hidden lg:flex item-end justify-start absolute w-full h-full -translate-y-[60px] translate-x-[30px]">
          <Image src={comilla1} width={129} height={113} />
        </div>
        <div className="hidden lg:flex item-start justify-end absolute w-full h-full -translate-x-[158px] translate-y-[60px]">
          <Image src={comilla2} />
        </div>
      </div>
    </div>
