...
export const Review = () => {
  return (
    <section className="lg:w-[913px] w-full h-[474px] mx-auto relative mb-0 md:mb-[50px]">
      <div className="w-[100%]  lg:text-start text-center  md:tracking-[-2%] md:leading-[38px] rounded-lg  h-[342px]  text-[20px] md:text-[32px] flex flex-col justify-between text-secondary-500 absolute font-avenirlight">
