...
export const Footer = () => {
  return (
    <section className="w-full h-[543px]  relative ">
      {/* Footer Items */}
      <div className="bg-secondary-700 w-full h-full clippyfooter flex items-center justify-start absolute">
      ...
      {/* Form */}
      <div className="w-[555px] h-[455px]  absolute flex flex-col items-center justify-center px-[50px] bg-white rounded-lg shadow-2xl md:mr-[100px] right-0">
        <div className="w-full h-[150px] flex items-center justify-start  flex-col  ">
          <h3 className="text-[26px] font-bold text-seconary-700">
            Vuoi scoprire quale corso si adatta meglio al tuo business?
          </h3>
          <h5 className="text-[20px] text-secondary-400">
        ...
        <form className="w-full  h-[180px] mt-[35px]">
          <input
            type="text"
            className="w-full h-[66px]  text-[20px] placeholder:px-[20px] placeholder:text-secondary-400 bg-secondary-50"
          ...
          <button className="w-[200px] h-[64px] bg-primary-500 mt-[10px] rounded-md">
            Contattaci
          </button>
        </form>
      </div>
